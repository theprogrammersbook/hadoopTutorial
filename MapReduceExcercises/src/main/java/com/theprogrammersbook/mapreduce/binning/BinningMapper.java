	...
	protected void map(Object key, Text value, Context context)
		...
		for (String tag : tagTokens) {
			...
			if (groomed.equalsIgnoreCase("hadoop")) {
				multipleOutputs.write("nagaraju", NullWritable.get(), value,  "hadoop/hadoop-tag");
				
			}

			if (groomed.equalsIgnoreCase("pig")) {
				multipleOutputs.write("nagaraju", NullWritable.get(), value,  "pig/pig-tag");
			}

			if (groomed.equalsIgnoreCase("hive")) {
				multipleOutputs.write("nagaraju", NullWritable.get(), value,  "hive/hive-tag");
			}

			if (groomed.equalsIgnoreCase("hbase")) {
				multipleOutputs.write("nagaraju", NullWritable.get(), value,  "hbase/hbase-tag");
			}
		}
		...
		if (post.toLowerCase().contains("hadoop")) {
			multipleOutputs.write("nagaraju", NullWritable.get(), value, "body/hadoop-post");
		}
	}
